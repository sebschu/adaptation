...
trials = remove_quotes(format_data(read.csv("../data/pilot/10_talker_specific_adaptation-trials.csv")))
exp_trials = remove_quotes(read.csv("../data/pilot/10_talker_specific_adaptation-exp_trials.csv"))
