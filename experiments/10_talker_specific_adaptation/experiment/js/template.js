...
function init() {
  ...
  exp.exp_trials = [].concat(_.shuffle(exposure_trial_generators[FIRST_CONDITION](SPEAKERS[FIRST_CONDITION])), _.shuffle(exposure_trial_generators[FIRST_CONDITION](SPEAKERS[SECOND_CONDITION]))); 
  exp.catch_trials = [];
  exp.system = {
