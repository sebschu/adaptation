...
trials.might = remove_quotes(read.csv("../data/6_comprehension_balanced-might-trials.csv"))
trials.probably = remove_quotes(read.csv("../data/6_comprehension_balanced-probably-trials.csv"))
...
exp_trials.might = read.csv("../data/6_comprehension_balanced-might-exp_trials.csv")
exp_trials.probably = read.csv("../data/6_comprehension_balanced-probably-exp_trials.csv")
...
ggplot(d.plot, aes(y=rating_norm, x=percentage_blue, col=modal)) + 
  geom_point() + 
  facet_wrap(~cond) + 
  geom_smooth(method="loess") + 
  xlab("percentage blue") + 
