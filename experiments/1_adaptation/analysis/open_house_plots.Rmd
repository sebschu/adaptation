...
plot_condition = function(d, plot_title) {
  ...
  p1 = ggplot(d_comparison, aes(x=percentage_blue, y=rating)) + stat_smooth(aes(col=modal, fill=modal),  method = 'loess', geom="area", alpha=0.5) + ggtitle(plot_title) + xlab("percentage")
