...
colscale = scale_color_manual(limits=modals_labels, values=c("#d95f02", "#66a61e", "#666666"))
...
```{r aggregate_plots, echo=FALSE, fig.width=8, fig.height=3.125}
...
plot_condition = function(d, plot_title) {
  ...
  p1 =  ggplot(d_comparison %>% 
               ...
               aes(x=percentage_blue, y=rating_m, group=modal, col=modal)) + 
    ...
    facet_wrap(~cond) + 
    colscale + 
    guides(col=guide_legend(title="Expression", ncol = 1)) + 
