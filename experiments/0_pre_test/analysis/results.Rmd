...
p1 = ggplot(d_comparison, aes(x=percentage_blue, y=rating)) + geom_point(aes(col=modal)) +  geom_smooth(aes(col=modal,linetype=blue)) + ggtitle(d$pair[1]) + xlab("percentage")
