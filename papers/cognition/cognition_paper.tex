...
listeners update their expectations about speakers' \textbf{mapping} between acoustic cues and phonemes \parencite[e.g.,][]{Kleinschmidt2015}.
...
\parencite[e.g.,][]{Clark1990,Pepper1974}. \jd{is it worth problematizing more clearly the semantic assumption of invariance of meaning for these uncertainty expressions? take inspiration from dan's book?} Second, there is considerable inter-speaker variability 
...
%lexica.
%In section~6, we discuss how the model also predicts updated interpretations of uncertainty expressions after a brief exposure to a different speaker and 
...
has also been observed for quantifiers \parencite{Degen2015}.
...
particularly surprising that the two metrics suggest different conclusions.\footnote{See \parencite{Gelman2018} for a proposal of a Bayesian $R^2$ value.}
...
the findings by \textcite{Yildirim2016} also extend to the class of uncertainty expressions. In Experiment~2, we further found a novel effect of adaptation on utterance interpretation.
...
\parencite[e.g.,][]{Kleinschmidt2012,Kleinschmidt2015,Roettger2019}, this suggests that semantic/pragmatic adaptation is the result of cognitive processes that operate in a similar fashion at all
...
the lexicon is highly dynamic and that listeners and speakers are able to compute novel senses on the fly \cite[e.g.,][]{ClarkGerrig1983,Griffiths2007?}. 
