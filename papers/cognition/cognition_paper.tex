...
The exact set of utterances \add{has only a small impact on the model's predictions} as long as the set includes the \textsc{bare}
...
uncertainty expression. \add{If this requirement is met, the model makes the same qualitative predictions, 
...
how certain a speaker has to be to utter a bare assertion \parencite[see, e.g.,][]{Lewis1976,Potts2007,Davis2007,Moss2018}. Mathematically, our assumption of bare forms having a threshold
