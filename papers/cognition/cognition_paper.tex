...
of representations listeners update during semantic/pragmatic adaptation -- estimates of the speaker's lexicon, or estimates of the speaker's uttterance preferences -- remains poorly understood.
...
a priming account, we should not find a difference between speaker bias conditions. Yet we did. In a more recent proposal, \textcite{Pickering2013} agued that
